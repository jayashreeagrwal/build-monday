...
export const KanbanColumnHeader = ({
  ...
  // ✅ Dummy handler for "New Task" button
  const handleNewTask = () => {
    alert(`Create new task in ${snakeCaseToTitleCase(board)} column`);
  };
  ...
  return (
    <div className="px-2 py-1.5 flex items-center justify-between">
      ...
      <Button onClick={handleNewTask} variant="ghost" size="icon" className="size-5">
